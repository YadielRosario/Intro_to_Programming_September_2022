...
app.MapPost("/bonus-calculations", ([FromBody] BonusCalculationRequest request, [FromServices] IProvideTheBusinessClock _clock) => {
    ...
    // if the balance is >= 5000 AND it is during business hours, they get a 5% bonus, otherwise, nothing.
    var bonus = _clock.IsDuringBusinessHours() && request.Balance >= 5000M ? request.AmountOfDeposit * 0.5M : 0;
